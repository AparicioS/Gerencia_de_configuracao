    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <form method="post" action="/master/euler-front/model/ModelCadastroUsuario.php">
                    <fieldset>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control cpf" id="cpf" name="cpf" maxlength="14" onchange="if(this.value.length == 14) { validaCPF(); }" placeholder="xxx.xxx.xxx-xx" required>
                            </div>
                            <div class="form-group col-md-4">
